...
export interface ICollection<T = unknown> {
    ...
    * @param attrs - Default values to set.
    ...
    * @param attrs - values to reset the collection with, defaults to current defaults.
    * @returns {Collection<T>} - The updated instance of Collection.
    */
   _reset?(attrs?: T): this;
    ...
    * @param values - values to merge into the collection.
    * @returns {Collection<T>} - The updated instance of Collection.
    */
   _merge?(values: T | T[]): this;
 ...
 */
export default class Collection<T = unknown> implements ICollection<T> {
   /**
   ...
   static create<T = unknown>(
      ...
      return instance as unknown as typeof instance & T;
   }
    ...
    * @returns {Collection<T>} - The updated instance of Collection.
    */
   _merge(values: unknown): this {
      _merge(this._state, values);
